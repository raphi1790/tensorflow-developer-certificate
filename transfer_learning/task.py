...
def download_images():
    ...
    path_to_zip = tf.keras.utils.get_file('cats_and_dogs.zip',cache_subdir='/home/raphi/projects/tensorflow-developer-certificate/transfer_learning/dataset', origin=_URL, extract=True)
    ...
    for fname_cats in fnames_cats_sample:
        shutil.move(os.path.join('dataset/cats_and_dogs_filtered/validation/cats',fname_cats), os.path.join('dataset/cats_and_dogs_filtered/test/cats',fname_cats))
    for fname_dogs in fnames_dogs_sample:
        shutil.move(os.path.join('dataset/cats_and_dogs_filtered/validation/dogs',fname_dogs), os.path.join('dataset/cats_and_dogs_filtered/test/dogs',fname_dogs))
