...
def download_data():
    imdb, info = tfds.load('imdb_reviews', data_dir='dataset', with_info=True, as_supervised=True)
    return imdb, info
...
if __name__ == "__main__":
    ...
    # imdb, info = download_data()
    imdb, info = tfds.load('imdb_reviews', data_dir='dataset', batch_size=batch_size, with_info=True, as_supervised=True)
